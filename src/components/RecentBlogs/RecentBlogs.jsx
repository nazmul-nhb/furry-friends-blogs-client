	...
	return (
		<section className="my-8 md:my-16 flex flex-col justify-center items-center gap-4">
			<SectionInfo
				...
				info={
					"Explore our recent blogs about pets. You can add it to your Wishlist for reading it later!"
				}
			/>
			...
			<Link className="mt-6" to={"/all-blogs"}>
				<Button
					className={
						"border px-4 md:px-6 py-1 md:py-2 rounded-3xl font-bold text-lg md:text-2xl"
					}
					color={"#1e40ad"}
