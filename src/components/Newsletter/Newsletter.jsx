...
const Newsletter = () => {
    ...
    return (
        <section className="my-8">
            <div className="">
                <h3 className="text-center font-bold text-3xl md:text-4xl text-furry mb-4">Subscribe to Our Newsletter</h3>
            ...
            <form onSubmit={handleNewsletter} className="flex-1 flex flex-col items-center justify-center gap-2 px-8 lg:px-0">
                <input placeholder="Enter Your Email Address" className="p-2 rounded-3xl text-center border border-[midnightblue] focus:outline-0 w-full md:w-1/2 focus:bg-[#6262b69b] transition duration-500" type="email" name="email" id="email" />
