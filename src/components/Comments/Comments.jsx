...
const Comments = ({ blog }) => {
	...
	return (
		<div className="my-4">
			<h3 className="font-semibold mb-2 text-furry md:text-xl">
			...
			{hideCommentBox ? (
				...
				>
					<textarea
						className="w-full lg:w-3/5 h-32 border bg-transparent border-furry rounded-lg p-2 outline-none focus:border-2"
						name="comment"
						id="comment"
