...
const ScrollIndicator = () => {
    ...
    return (
        <div className={`w-full mt-[1px] flex items-center gap-1 h-3 fixed min-[430px]:top-20 top-[68px] md:top-[88px] left-0 z-[100] ${visible ? 'bg-gradient-to-l from-[#e3e7f4d4] to-[#7690e5d2]' : 'bg-transparent'}`}>
