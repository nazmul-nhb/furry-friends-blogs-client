...
const AddBlog = () => {
    ...
    return (
        <section className="mx-2 md:mx-8 my-2 md:my-8 p-2 md:px-4">
            ...
            {
                showModal && (
                    <dialog open className="w-[96%] xl:w-auto h-dvh mt-20 md:mt-24 bg-opacity-95 bg-[#d9dff3c3] fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg z-20 overflow-y-auto">
