...
const AddBlog = () => {
	...
	return (
		<section className="mx-2 md:mx-8 my-2 md:my-8 p-2 md:px-4">
			...
			<h2 className="text-lg md:text-3xl text-furry font-bold text-center mb-8">
			...
			>
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
					...
					<div className="lg:col-span-2 w-full flex flex-col gap-3">
						...
						<input
							...
							name="blog_title"
							id="blog_title"
							placeholder=" Title for Your Blog (Max: 96 Characters)"
						/>
						{errors.blog_title && (
					...
					<div className="lg:col-span-2 w-full flex flex-col gap-3">
						...
						<textarea
							...
							className="h-44 bg-transparent focus:border-2 p-2 rounded-lg border border-furry transition duration-500 focus:outline-0"
							type="text"
				...
				<div className="flex gap-6 flex-col md:flex-row items-center justify-center">
					<Button
						...
						buttonType={"button"}
						className={
							"border !border-furry w-full text-xl font-semibold p-2 rounded-3xl !bg-transparent hover:!bg-furry focus:border-2"
						}
						color={"white"}
						hoverColor={"#1e40ad"}
						hoverBgColor={"#1e40ad"}
					...
					<Button
						buttonType={"submit"}
						className={
							"border w-full text-xl font-semibold p-2 rounded-3xl"
						}
						buttonText={"Submit"}
						color={"#1e40ad"}
						hoverColor={"white"}
