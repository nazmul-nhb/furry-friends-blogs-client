        ...
        <section className="mx-2 md:mx-8 my-2 md:my-8 p-2 md:px-4">
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center justify-between gap-6 lg:gap-8">
                ...
                <div className="flex-1 flex flex-col gap-2">
                    ...
                    <form onSubmit={handleSubmit(handleLogin)} className="w-full flex flex-col gap-6 px-4 lg:px-8 py-4 lg:py-6 shadow-lg shadow-[#8689ee] border border-[#d3d0d0] rounded-md">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <input
                                ...
                                className="bg-transparent focus:border-2 p-2 rounded-lg border border-furry transition duration-500 focus:outline-0" type="email" name="email" id="email" placeholder="Your Email" />
                            {
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-transparent focus:border-2 p-2 rounded-lg border border-furry transition duration-500 focus:outline-0" type={showPassword ? "text" : "password"} name="password" id="password" placeholder="Your Password" />
                                {
